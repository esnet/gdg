...
// AddUserToOrg provides a mock function for the type organizationUserCrudApi
func (_mock *organizationUserCrudApi) AddUserToOrg(role string, orgSlug string, userId int64) error {
...
func (_c *organizationUserCrudApi_AddUserToOrg_Call) Return(err error) *organizationUserCrudApi_AddUserToOrg_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *organizationUserCrudApi_AddUserToOrg_Call) RunAndReturn(run func(role string, orgSlug string, userId int64) error) *organizationUserCrudApi_AddUserToOrg_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteUserFromOrg provides a mock function for the type organizationUserCrudApi
func (_mock *organizationUserCrudApi) DeleteUserFromOrg(orgId string, userId int64) error {
...
func (_c *organizationUserCrudApi_DeleteUserFromOrg_Call) Return(err error) *organizationUserCrudApi_DeleteUserFromOrg_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *organizationUserCrudApi_DeleteUserFromOrg_Call) RunAndReturn(run func(orgId string, userId int64) error) *organizationUserCrudApi_DeleteUserFromOrg_Call {
	_c.Call.Return(run)
	return _c
}

// ListOrgUsers provides a mock function for the type organizationUserCrudApi
func (_mock *organizationUserCrudApi) ListOrgUsers(orgId int64) []*models.OrgUserDTO {
...
func (_c *organizationUserCrudApi_ListOrgUsers_Call) Return(orgUserDTOs []*models.OrgUserDTO) *organizationUserCrudApi_ListOrgUsers_Call {
	_c.Call.Return(orgUserDTOs)
	return _c
}

func (_c *organizationUserCrudApi_ListOrgUsers_Call) RunAndReturn(run func(orgId int64) []*models.OrgUserDTO) *organizationUserCrudApi_ListOrgUsers_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateUserInOrg provides a mock function for the type organizationUserCrudApi
func (_mock *organizationUserCrudApi) UpdateUserInOrg(role string, orgSlug string, userId int64) error {
	ret := _mock.Called(role, orgSlug, userId)
...
func (_c *organizationUserCrudApi_UpdateUserInOrg_Call) Return(err error) *organizationUserCrudApi_UpdateUserInOrg_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *organizationUserCrudApi_UpdateUserInOrg_Call) RunAndReturn(run func(role string, orgSlug string, userId int64) error) *organizationUserCrudApi_UpdateUserInOrg_Call {
	_c.Call.Return(run)
	return _c
}
