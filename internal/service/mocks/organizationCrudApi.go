...
func (_mock *organizationCrudApi) DownloadOrganizations(filter filters.Filter) []string {
...
func (_c *organizationCrudApi_DownloadOrganizations_Call) RunAndReturn(run func(filter filters.Filter) []string) *organizationCrudApi_DownloadOrganizations_Call {
	_c.Call.Return(run)
	return _c
}

// ListOrganizations provides a mock function for the type organizationCrudApi
func (_mock *organizationCrudApi) ListOrganizations(filter filters.Filter, withPreferences bool) []*types.OrgsDTOWithPreferences {
...
func (_c *organizationCrudApi_ListOrganizations_Call) RunAndReturn(run func(filter filters.Filter, withPreferences bool) []*types.OrgsDTOWithPreferences) *organizationCrudApi_ListOrganizations_Call {
	_c.Call.Return(run)
	return _c
}

// UploadOrganizations provides a mock function for the type organizationCrudApi
func (_mock *organizationCrudApi) UploadOrganizations(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *organizationCrudApi_UploadOrganizations_Call) RunAndReturn(run func(filter filters.Filter) []string) *organizationCrudApi_UploadOrganizations_Call {
	_c.Call.Return(run)
	return _c
}
