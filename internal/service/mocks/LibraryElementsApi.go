...
func (_mock *LibraryElementsApi) DeleteAllLibraryElements(filter filters.Filter) []string {
...
func (_c *LibraryElementsApi_DeleteAllLibraryElements_Call) RunAndReturn(run func(filter filters.Filter) []string) *LibraryElementsApi_DeleteAllLibraryElements_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadLibraryElements provides a mock function for the type LibraryElementsApi
func (_mock *LibraryElementsApi) DownloadLibraryElements(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *LibraryElementsApi_DownloadLibraryElements_Call) RunAndReturn(run func(filter filters.Filter) []string) *LibraryElementsApi_DownloadLibraryElements_Call {
	_c.Call.Return(run)
	return _c
}

// ListLibraryElements provides a mock function for the type LibraryElementsApi
func (_mock *LibraryElementsApi) ListLibraryElements(filter filters.Filter) []*models.LibraryElementDTO {
	ret := _mock.Called(filter)
...
func (_c *LibraryElementsApi_ListLibraryElements_Call) Return(libraryElementDTOs []*models.LibraryElementDTO) *LibraryElementsApi_ListLibraryElements_Call {
	_c.Call.Return(libraryElementDTOs)
	return _c
}

func (_c *LibraryElementsApi_ListLibraryElements_Call) RunAndReturn(run func(filter filters.Filter) []*models.LibraryElementDTO) *LibraryElementsApi_ListLibraryElements_Call {
	_c.Call.Return(run)
	return _c
}

// ListLibraryElementsConnections provides a mock function for the type LibraryElementsApi
func (_mock *LibraryElementsApi) ListLibraryElementsConnections(filter filters.Filter, connectionID string) []*models.DashboardFullWithMeta {
...
func (_c *LibraryElementsApi_ListLibraryElementsConnections_Call) RunAndReturn(run func(filter filters.Filter, connectionID string) []*models.DashboardFullWithMeta) *LibraryElementsApi_ListLibraryElementsConnections_Call {
	_c.Call.Return(run)
	return _c
}

// UploadLibraryElements provides a mock function for the type LibraryElementsApi
func (_mock *LibraryElementsApi) UploadLibraryElements(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *LibraryElementsApi_UploadLibraryElements_Call) RunAndReturn(run func(filter filters.Filter) []string) *LibraryElementsApi_UploadLibraryElements_Call {
	_c.Call.Return(run)
	return _c
}
