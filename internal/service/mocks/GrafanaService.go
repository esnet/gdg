...
func (_m *GrafanaService) ListOrganizations(filter filters.Filter) []*types.OrgsDTOWithPreferences {
	ret := _m.Called(filter)
...
func (_c *GrafanaService_ListOrganizations_Call) Return(_a0 []*types.OrgsDTOWithPreferences) *GrafanaService_ListOrganizations_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_ListOrganizations_Call) RunAndReturn(run func(filters.Filter) []*types.OrgsDTOWithPreferences) *GrafanaService_ListOrganizations_Call {
	_c.Call.Return(run)
	return _c
}
