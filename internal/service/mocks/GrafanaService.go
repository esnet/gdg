...
func (_c *GrafanaService_UploadUsers_Call) Return(_a0 []models.UserProfileDTO) *GrafanaService_UploadUsers_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_UploadUsers_Call) RunAndReturn(run func(filters.Filter) []models.UserProfileDTO) *GrafanaService_UploadUsers_Call {
	_c.Call.Return(run)
	return _c
}
