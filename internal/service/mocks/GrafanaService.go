...
// ClearContactPoints provides a mock function with no fields
func (_m *GrafanaService) ClearContactPoints() ([]string, error) {
	ret := _m.Called()
...
func (_c *GrafanaService_ClearContactPoints_Call) Return(_a0 []string, _a1 error) *GrafanaService_ClearContactPoints_Call {
...
// CreateServiceAccountToken provides a mock function with given fields: serviceAccountId, name, expiration
func (_m *GrafanaService) CreateServiceAccountToken(serviceAccountId int64, name string, expiration int64) (*models.NewAPIKeyResult, error) {
	ret := _m.Called(serviceAccountId, name, expiration)
	...
	if rf, ok := ret.Get(0).(func(int64, string, int64) (*models.NewAPIKeyResult, error)); ok {
		return rf(serviceAccountId, name, expiration)
	}
	if rf, ok := ret.Get(0).(func(int64, string, int64) *models.NewAPIKeyResult); ok {
		r0 = rf(serviceAccountId, name, expiration)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(int64, string, int64) error); ok {
		r1 = rf(serviceAccountId, name, expiration)
	} else {
		r1 = ret.Error(1)
	}
...
// DeleteAllServiceAccounts provides a mock function with no fields
...
// DownloadContactPoints provides a mock function with no fields
func (_m *GrafanaService) DownloadContactPoints() (string, error) {
	ret := _m.Called()
...
func (_c *GrafanaService_DownloadContactPoints_Call) Return(_a0 string, _a1 error) *GrafanaService_DownloadContactPoints_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
// GetUserInfo provides a mock function with no fields
...
// InitOrganizations provides a mock function with no fields
...
// IsEnterprise provides a mock function with no fields
...
// ListContactPoints provides a mock function with no fields
func (_m *GrafanaService) ListContactPoints() ([]*models.EmbeddedContactPoint, error) {
	ret := _m.Called()
...
func (_c *GrafanaService_ListContactPoints_Call) Return(_a0 []*models.EmbeddedContactPoint, _a1 error) *GrafanaService_ListContactPoints_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *GrafanaService) ListDashboards(filter filters.Filter) []*internaltypes.NestedHit {
	ret := _m.Called(filter)
	...
	var r0 []*internaltypes.NestedHit
	if rf, ok := ret.Get(0).(func(filters.Filter) []*internaltypes.NestedHit); ok {
		r0 = rf(filter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*internaltypes.NestedHit)
		}
	}
...
func (_c *GrafanaService_ListDashboards_Call) Return(_a0 []*internaltypes.NestedHit) *GrafanaService_ListDashboards_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_ListDashboards_Call) RunAndReturn(run func(filters.Filter) []*internaltypes.NestedHit) *GrafanaService_ListDashboards_Call {
	_c.Call.Return(run)
	return _c
}

// ListFolderPermissions provides a mock function with given fields: filter
func (_m *GrafanaService) ListFolderPermissions(filter filters.Filter) map[*internaltypes.NestedHit][]*models.DashboardACLInfoDTO {
	ret := _m.Called(filter)
	...
	var r0 map[*internaltypes.NestedHit][]*models.DashboardACLInfoDTO
	if rf, ok := ret.Get(0).(func(filters.Filter) map[*internaltypes.NestedHit][]*models.DashboardACLInfoDTO); ok {
		r0 = rf(filter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[*internaltypes.NestedHit][]*models.DashboardACLInfoDTO)
		}
	}
...
func (_c *GrafanaService_ListFolderPermissions_Call) Return(_a0 map[*internaltypes.NestedHit][]*models.DashboardACLInfoDTO) *GrafanaService_ListFolderPermissions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_ListFolderPermissions_Call) RunAndReturn(run func(filters.Filter) map[*internaltypes.NestedHit][]*models.DashboardACLInfoDTO) *GrafanaService_ListFolderPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// ListFolders provides a mock function with given fields: filter
func (_m *GrafanaService) ListFolders(filter filters.Filter) []*internaltypes.NestedHit {
	ret := _m.Called(filter)
...
func (_c *GrafanaService_ListFolders_Call) Return(_a0 []*internaltypes.NestedHit) *GrafanaService_ListFolders_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_ListFolders_Call) RunAndReturn(run func(filters.Filter) []*internaltypes.NestedHit) *GrafanaService_ListFolders_Call {
	_c.Call.Return(run)
	return _c
}
...
// ListServiceAccounts provides a mock function with no fields
...
// UploadContactPoints provides a mock function with no fields
func (_m *GrafanaService) UploadContactPoints() ([]string, error) {
	ret := _m.Called()
...
func (_c *GrafanaService_UploadContactPoints_Call) Return(_a0 []string, _a1 error) *GrafanaService_UploadContactPoints_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *GrafanaService) UploadDashboards(filter filters.Filter) error {
	ret := _m.Called(filter)
...
func (_c *GrafanaService_UploadDashboards_Call) Return(_a0 error) *GrafanaService_UploadDashboards_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_UploadDashboards_Call) RunAndReturn(run func(filters.Filter) error) *GrafanaService_UploadDashboards_Call {
	_c.Call.Return(run)
	return _c
}
