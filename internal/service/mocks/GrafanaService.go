...
func (_c *GrafanaService_ListServiceAccounts_Call) Return(_a0 []*api.ServiceAccountDTOWithTokens) *GrafanaService_ListServiceAccounts_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GrafanaService_ListServiceAccounts_Call) RunAndReturn(run func() []*api.ServiceAccountDTOWithTokens) *GrafanaService_ListServiceAccounts_Call {
	_c.Call.Return(run)
	return _c
}
