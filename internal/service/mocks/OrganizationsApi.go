...
func (_mock *OrganizationsApi) DownloadOrganizations(filter filters.Filter) []string {
...
func (_c *OrganizationsApi_DownloadOrganizations_Call) RunAndReturn(run func(filter filters.Filter) []string) *OrganizationsApi_DownloadOrganizations_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *OrganizationsApi) ListOrganizations(filter filters.Filter, withPreferences bool) []*types.OrgsDTOWithPreferences {
	...
	if returnFunc, ok := ret.Get(0).(func(filters.Filter, bool) []*types.OrgsDTOWithPreferences); ok {
...
func (_c *OrganizationsApi_ListOrganizations_Call) RunAndReturn(run func(filter filters.Filter, withPreferences bool) []*types.OrgsDTOWithPreferences) *OrganizationsApi_ListOrganizations_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *OrganizationsApi) UploadOrganizations(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *OrganizationsApi_UploadOrganizations_Call) RunAndReturn(run func(filter filters.Filter) []string) *OrganizationsApi_UploadOrganizations_Call {
	_c.Call.Return(run)
	return _c
}
