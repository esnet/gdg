...
func (_mock *DashboardsApi) DeleteAllDashboards(filter filters.Filter) []string {
...
func (_c *DashboardsApi_DeleteAllDashboards_Call) RunAndReturn(run func(filter filters.Filter) []string) *DashboardsApi_DeleteAllDashboards_Call {
	_c.Call.Return(run)
	return _c
}
