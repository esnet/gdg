...
func (_m *DashboardsApi) ListDashboards(filter filters.Filter) []*internaltypes.NestedHit {
	ret := _m.Called(filter)
...
func (_c *DashboardsApi_ListDashboards_Call) Return(_a0 []*internaltypes.NestedHit) *DashboardsApi_ListDashboards_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DashboardsApi_ListDashboards_Call) RunAndReturn(run func(filters.Filter) []*internaltypes.NestedHit) *DashboardsApi_ListDashboards_Call {
	_c.Call.Return(run)
	return _c
}
