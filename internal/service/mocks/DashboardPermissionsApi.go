...
func (_mock *DashboardPermissionsApi) ClearDashboardPermissions(filterReq filters.Filter) error {
...
func (_c *DashboardPermissionsApi_ClearDashboardPermissions_Call) RunAndReturn(run func(filterReq filters.Filter) error) *DashboardPermissionsApi_ClearDashboardPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadDashboardPermissions provides a mock function for the type DashboardPermissionsApi
func (_mock *DashboardPermissionsApi) DownloadDashboardPermissions(filterReq filters.Filter) ([]string, error) {
	ret := _mock.Called(filterReq)
...
func (_c *DashboardPermissionsApi_DownloadDashboardPermissions_Call) RunAndReturn(run func(filterReq filters.Filter) ([]string, error)) *DashboardPermissionsApi_DownloadDashboardPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// ListDashboardPermissions provides a mock function for the type DashboardPermissionsApi
func (_mock *DashboardPermissionsApi) ListDashboardPermissions(filterReq filters.Filter) ([]types.DashboardAndPermissions, error) {
	ret := _mock.Called(filterReq)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(filters.Filter) ([]types.DashboardAndPermissions, error)); ok {
		return returnFunc(filterReq)
	}
	if returnFunc, ok := ret.Get(0).(func(filters.Filter) []types.DashboardAndPermissions); ok {
		r0 = returnFunc(filterReq)
	} else {
		if ret.Get(0) != nil {
...
func (_c *DashboardPermissionsApi_ListDashboardPermissions_Call) RunAndReturn(run func(filterReq filters.Filter) ([]types.DashboardAndPermissions, error)) *DashboardPermissionsApi_ListDashboardPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// UploadDashboardPermissions provides a mock function for the type DashboardPermissionsApi
func (_mock *DashboardPermissionsApi) UploadDashboardPermissions(filterReq filters.Filter) ([]string, error) {
	ret := _mock.Called(filterReq)
...
func (_c *DashboardPermissionsApi_UploadDashboardPermissions_Call) RunAndReturn(run func(filterReq filters.Filter) ([]string, error)) *DashboardPermissionsApi_UploadDashboardPermissions_Call {
	_c.Call.Return(run)
	return _c
}
