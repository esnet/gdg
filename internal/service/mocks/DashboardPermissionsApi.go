...
func (_m *DashboardPermissionsApi) ListDashboardPermissions(filterReq filters.Filter) ([]types.DashboardAndPermissions, error) {
	ret := _m.Called(filterReq)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(filters.Filter) ([]types.DashboardAndPermissions, error)); ok {
		return rf(filterReq)
	}
	if rf, ok := ret.Get(0).(func(filters.Filter) []types.DashboardAndPermissions); ok {
		r0 = rf(filterReq)
	} else {
		if ret.Get(0) != nil {
...
func (_c *DashboardPermissionsApi_ListDashboardPermissions_Call) Return(_a0 []types.DashboardAndPermissions, _a1 error) *DashboardPermissionsApi_ListDashboardPermissions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DashboardPermissionsApi_ListDashboardPermissions_Call) RunAndReturn(run func(filters.Filter) ([]types.DashboardAndPermissions, error)) *DashboardPermissionsApi_ListDashboardPermissions_Call {
	_c.Call.Return(run)
	return _c
}
