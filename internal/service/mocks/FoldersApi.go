...
func (_mock *FoldersApi) DeleteAllFolders(filter filters.Filter) []string {
...
func (_c *FoldersApi_DeleteAllFolders_Call) RunAndReturn(run func(filter filters.Filter) []string) *FoldersApi_DeleteAllFolders_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadFolderPermissions provides a mock function for the type FoldersApi
func (_mock *FoldersApi) DownloadFolderPermissions(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *FoldersApi_DownloadFolderPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *FoldersApi_DownloadFolderPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadFolders provides a mock function for the type FoldersApi
func (_mock *FoldersApi) DownloadFolders(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *FoldersApi_DownloadFolders_Call) RunAndReturn(run func(filter filters.Filter) []string) *FoldersApi_DownloadFolders_Call {
	_c.Call.Return(run)
	return _c
}

// ListFolderPermissions provides a mock function for the type FoldersApi
func (_mock *FoldersApi) ListFolderPermissions(filter filters.Filter) map[*types.NestedHit][]*models.DashboardACLInfoDTO {
	ret := _mock.Called(filter)
	...
	if returnFunc, ok := ret.Get(0).(func(filters.Filter) map[*types.NestedHit][]*models.DashboardACLInfoDTO); ok {
		r0 = returnFunc(filter)
	} else {
		if ret.Get(0) != nil {
...
func (_c *FoldersApi_ListFolderPermissions_Call) RunAndReturn(run func(filter filters.Filter) map[*types.NestedHit][]*models.DashboardACLInfoDTO) *FoldersApi_ListFolderPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// ListFolders provides a mock function for the type FoldersApi
func (_mock *FoldersApi) ListFolders(filter filters.Filter) []*types.NestedHit {
	ret := _mock.Called(filter)
	...
	if returnFunc, ok := ret.Get(0).(func(filters.Filter) []*types.NestedHit); ok {
		r0 = returnFunc(filter)
	} else {
		if ret.Get(0) != nil {
...
func (_c *FoldersApi_ListFolders_Call) RunAndReturn(run func(filter filters.Filter) []*types.NestedHit) *FoldersApi_ListFolders_Call {
	_c.Call.Return(run)
	return _c
}

// UploadFolderPermissions provides a mock function for the type FoldersApi
func (_mock *FoldersApi) UploadFolderPermissions(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *FoldersApi_UploadFolderPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *FoldersApi_UploadFolderPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// UploadFolders provides a mock function for the type FoldersApi
func (_mock *FoldersApi) UploadFolders(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *FoldersApi_UploadFolders_Call) RunAndReturn(run func(filter filters.Filter) []string) *FoldersApi_UploadFolders_Call {
	_c.Call.Return(run)
	return _c
}
