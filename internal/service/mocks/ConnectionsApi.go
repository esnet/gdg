...
func (_mock *ConnectionsApi) DeleteAllConnectionPermissions(filter filters.Filter) []string {
...
func (_c *ConnectionsApi_DeleteAllConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionsApi_DeleteAllConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteAllConnections provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) DeleteAllConnections(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionsApi_DeleteAllConnections_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionsApi_DeleteAllConnections_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadConnectionPermissions provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) DownloadConnectionPermissions(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionsApi_DownloadConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionsApi_DownloadConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadConnections provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) DownloadConnections(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionsApi_DownloadConnections_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionsApi_DownloadConnections_Call {
	_c.Call.Return(run)
	return _c
}

// ListConnectionPermissions provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) ListConnectionPermissions(filter filters.Filter) []types.ConnectionPermissionItem {
	ret := _mock.Called(filter)
	...
	if returnFunc, ok := ret.Get(0).(func(filters.Filter) []types.ConnectionPermissionItem); ok {
		r0 = returnFunc(filter)
	} else {
		if ret.Get(0) != nil {
...
func (_c *ConnectionsApi_ListConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []types.ConnectionPermissionItem) *ConnectionsApi_ListConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// ListConnections provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) ListConnections(filter filters.Filter) []models.DataSourceListItemDTO {
	ret := _mock.Called(filter)
...
func (_c *ConnectionsApi_ListConnections_Call) RunAndReturn(run func(filter filters.Filter) []models.DataSourceListItemDTO) *ConnectionsApi_ListConnections_Call {
	_c.Call.Return(run)
	return _c
}

// UploadConnectionPermissions provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) UploadConnectionPermissions(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionsApi_UploadConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionsApi_UploadConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// UploadConnections provides a mock function for the type ConnectionsApi
func (_mock *ConnectionsApi) UploadConnections(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionsApi_UploadConnections_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionsApi_UploadConnections_Call {
	_c.Call.Return(run)
	return _c
}
