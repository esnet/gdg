...
func (_c *ServiceAccountApi_ListServiceAccounts_Call) Return(_a0 []*api.ServiceAccountDTOWithTokens) *ServiceAccountApi_ListServiceAccounts_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ServiceAccountApi_ListServiceAccounts_Call) RunAndReturn(run func() []*api.ServiceAccountDTOWithTokens) *ServiceAccountApi_ListServiceAccounts_Call {
	_c.Call.Return(run)
	return _c
}
