...
func (_mock *TeamsApi) DeleteTeam(filter filters.Filter) ([]*models.TeamDTO, error) {
...
func (_c *TeamsApi_DeleteTeam_Call) RunAndReturn(run func(filter filters.Filter) ([]*models.TeamDTO, error)) *TeamsApi_DeleteTeam_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadTeams provides a mock function for the type TeamsApi
func (_mock *TeamsApi) DownloadTeams(filter filters.Filter) map[*models.TeamDTO][]*models.TeamMemberDTO {
	ret := _mock.Called(filter)
...
func (_c *TeamsApi_DownloadTeams_Call) RunAndReturn(run func(filter filters.Filter) map[*models.TeamDTO][]*models.TeamMemberDTO) *TeamsApi_DownloadTeams_Call {
	_c.Call.Return(run)
	return _c
}

// ListTeams provides a mock function for the type TeamsApi
func (_mock *TeamsApi) ListTeams(filter filters.Filter) map[*models.TeamDTO][]*models.TeamMemberDTO {
	ret := _mock.Called(filter)
...
func (_c *TeamsApi_ListTeams_Call) RunAndReturn(run func(filter filters.Filter) map[*models.TeamDTO][]*models.TeamMemberDTO) *TeamsApi_ListTeams_Call {
	_c.Call.Return(run)
	return _c
}

// UploadTeams provides a mock function for the type TeamsApi
func (_mock *TeamsApi) UploadTeams(filter filters.Filter) map[*models.TeamDTO][]*models.TeamMemberDTO {
	ret := _mock.Called(filter)
...
func (_c *TeamsApi_UploadTeams_Call) RunAndReturn(run func(filter filters.Filter) map[*models.TeamDTO][]*models.TeamMemberDTO) *TeamsApi_UploadTeams_Call {
	_c.Call.Return(run)
	return _c
}
