...
func (_mock *UsersApi) DeleteAllUsers(filter filters.Filter) []string {
...
func (_c *UsersApi_DeleteAllUsers_Call) RunAndReturn(run func(filter filters.Filter) []string) *UsersApi_DeleteAllUsers_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadUsers provides a mock function for the type UsersApi
func (_mock *UsersApi) DownloadUsers(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *UsersApi_DownloadUsers_Call) RunAndReturn(run func(filter filters.Filter) []string) *UsersApi_DownloadUsers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *UsersApi) ListUsers(filter filters.Filter) []*models.UserSearchHitDTO {
	ret := _mock.Called(filter)
...
func (_c *UsersApi_ListUsers_Call) RunAndReturn(run func(filter filters.Filter) []*models.UserSearchHitDTO) *UsersApi_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *UsersApi) UploadUsers(filter filters.Filter) []types.UserProfileWithAuth {
	ret := _mock.Called(filter)
	...
	if returnFunc, ok := ret.Get(0).(func(filters.Filter) []types.UserProfileWithAuth); ok {
		r0 = returnFunc(filter)
	} else {
		if ret.Get(0) != nil {
...
func (_c *UsersApi_UploadUsers_Call) RunAndReturn(run func(filter filters.Filter) []types.UserProfileWithAuth) *UsersApi_UploadUsers_Call {
	_c.Call.Return(run)
	return _c
}
