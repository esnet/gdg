...
func (_mock *ConnectionPermissions) DeleteAllConnectionPermissions(filter filters.Filter) []string {
...
func (_c *ConnectionPermissions_DeleteAllConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionPermissions_DeleteAllConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadConnectionPermissions provides a mock function for the type ConnectionPermissions
func (_mock *ConnectionPermissions) DownloadConnectionPermissions(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionPermissions_DownloadConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionPermissions_DownloadConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// ListConnectionPermissions provides a mock function for the type ConnectionPermissions
func (_mock *ConnectionPermissions) ListConnectionPermissions(filter filters.Filter) []types.ConnectionPermissionItem {
	ret := _mock.Called(filter)
...
func (_c *ConnectionPermissions_ListConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []types.ConnectionPermissionItem) *ConnectionPermissions_ListConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}

// UploadConnectionPermissions provides a mock function for the type ConnectionPermissions
func (_mock *ConnectionPermissions) UploadConnectionPermissions(filter filters.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *ConnectionPermissions_UploadConnectionPermissions_Call) RunAndReturn(run func(filter filters.Filter) []string) *ConnectionPermissions_UploadConnectionPermissions_Call {
	_c.Call.Return(run)
	return _c
}
