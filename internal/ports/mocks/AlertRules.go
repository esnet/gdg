...
func (_mock *AlertRules) UploadAlertRules(filter ports.Filter) error {
	ret := _mock.Called(filter)
...
func (_c *AlertRules_UploadAlertRules_Call) RunAndReturn(run func(filter ports.Filter) error) *AlertRules_UploadAlertRules_Call {
	_c.Call.Return(run)
	return _c
}
