...
func (_mock *UsersApi) DeleteAllUsers(filter outbound.Filter) []string {
...
func (_c *UsersApi_DeleteAllUsers_Call) Run(run func(filter outbound.Filter)) *UsersApi_DeleteAllUsers_Call {
...
func (_c *UsersApi_DeleteAllUsers_Call) RunAndReturn(run func(filter outbound.Filter) []string) *UsersApi_DeleteAllUsers_Call {
	_c.Call.Return(run)
	return _c
}

// DownloadUsers provides a mock function for the type UsersApi
func (_mock *UsersApi) DownloadUsers(filter outbound.Filter) []string {
	ret := _mock.Called(filter)
...
func (_c *UsersApi_DownloadUsers_Call) Run(run func(filter outbound.Filter)) *UsersApi_DownloadUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 outbound.Filter
		if args[0] != nil {
			arg0 = args[0].(outbound.Filter)
...
func (_c *UsersApi_DownloadUsers_Call) RunAndReturn(run func(filter outbound.Filter) []string) *UsersApi_DownloadUsers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *UsersApi) ListUsers(filter outbound.Filter) []*models.UserSearchHitDTO {
	ret := _mock.Called(filter)
...
func (_c *UsersApi_ListUsers_Call) Run(run func(filter outbound.Filter)) *UsersApi_ListUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 outbound.Filter
		if args[0] != nil {
			arg0 = args[0].(outbound.Filter)
...
func (_c *UsersApi_ListUsers_Call) RunAndReturn(run func(filter outbound.Filter) []*models.UserSearchHitDTO) *UsersApi_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *UsersApi) UploadUsers(filter outbound.Filter) []domain.UserProfileWithAuth {
	ret := _mock.Called(filter)
...
func (_c *UsersApi_UploadUsers_Call) Run(run func(filter outbound.Filter)) *UsersApi_UploadUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 outbound.Filter
		if args[0] != nil {
			arg0 = args[0].(outbound.Filter)
...
func (_c *UsersApi_UploadUsers_Call) RunAndReturn(run func(filter outbound.Filter) []domain.UserProfileWithAuth) *UsersApi_UploadUsers_Call {
	_c.Call.Return(run)
	return _c
}
