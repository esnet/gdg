...
// NewAlertPolicies creates a new instance of AlertPolicies. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
...
func (_m *AlertPolicies) EXPECT() *AlertPolicies_Expecter {
	return &AlertPolicies_Expecter{mock: &_m.Mock}
}
...
type AlertPolicies_ClearAlertNotifications_Call struct {
	*mock.Call
}
...
func (_e *AlertPolicies_Expecter) ClearAlertNotifications() *AlertPolicies_ClearAlertNotifications_Call {
	return &AlertPolicies_ClearAlertNotifications_Call{Call: _e.mock.On("ClearAlertNotifications")}
}
...
type AlertPolicies_DownloadAlertNotifications_Call struct {
	*mock.Call
}
...
func (_e *AlertPolicies_Expecter) DownloadAlertNotifications() *AlertPolicies_DownloadAlertNotifications_Call {
	return &AlertPolicies_DownloadAlertNotifications_Call{Call: _e.mock.On("DownloadAlertNotifications")}
}
...
type AlertPolicies_ListAlertNotifications_Call struct {
	*mock.Call
}
...
func (_e *AlertPolicies_Expecter) ListAlertNotifications() *AlertPolicies_ListAlertNotifications_Call {
	return &AlertPolicies_ListAlertNotifications_Call{Call: _e.mock.On("ListAlertNotifications")}
}
...
type AlertPolicies_UploadAlertNotifications_Call struct {
	*mock.Call
}
...
func (_e *AlertPolicies_Expecter) UploadAlertNotifications() *AlertPolicies_UploadAlertNotifications_Call {
	return &AlertPolicies_UploadAlertNotifications_Call{Call: _e.mock.On("UploadAlertNotifications")}
}
