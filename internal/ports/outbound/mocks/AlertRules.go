...
func (_c *AlertRules_UploadAlertRules_Call) Return(alertRuleWithNestedFolders []*domain.AlertRuleWithNestedFolder, err error) *AlertRules_UploadAlertRules_Call {
	_c.Call.Return(alertRuleWithNestedFolders, err)
	return _c
}
