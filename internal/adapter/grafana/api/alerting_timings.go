...
func (s *DashNGoImpl) DownloadAlertTimings() (string, error) {
	...
	dsPath := s.resources.BuildResourcePath(s.grafanaConf, timingsFile, domain.AlertingResource, s.isLocal(), false)
...
func (s *DashNGoImpl) UploadAlertTimings() ([]string, error) {
	...
	fileLocation := s.resources.BuildResourcePath(s.grafanaConf, timingsFile, domain.AlertingResource, s.isLocal(), false)
