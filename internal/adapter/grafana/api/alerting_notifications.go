...
func (s *DashNGoImpl) DownloadAlertNotifications() (string, error) {
	...
	dsPath := resources.BuildResourcePath(s.grafanaConf, policiesFile, domain.AlertingResource, s.isLocal(), false)
...
func (s *DashNGoImpl) UploadAlertNotifications() (*models.Route, error) {
	...
	fileLocation := resources.BuildResourcePath(s.grafanaConf, policiesFile, domain.AlertingResource, s.isLocal(), false)
