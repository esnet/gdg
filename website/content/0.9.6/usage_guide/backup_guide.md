...
{{% notice style="note" %}} Grafana has a contact point type named 'grafana-default-email' that has an inconsistent behavior.
...
{{% notice style="note" %}} Starting with v0.4.6 "Datasources" was renamed to connections. {{% /notice %}}
...
{{% notice style="warning" title="Enterprise required" %}}
...
{{% expand title="Example Output (v13+):" %}}
```
┌─────────────────────┬───────────┐
│ DASHBOARD NAME      │ UID       │
├─────────────────────┼───────────┤
